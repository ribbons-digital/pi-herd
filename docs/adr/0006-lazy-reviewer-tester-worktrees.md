...
The first `pi-herd send reviewer ...` or `pi-herd send tester ...` activation materializes the role worktree from the implementation branch before launching the role session and sending the prompt.
